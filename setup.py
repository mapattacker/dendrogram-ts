...
setup(
  ...
  packages = ['dendrogram_ts'],   # Chose the same as "name"
  version = '0.1.0-beta.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mapattacker/dendrogram-ts/archive/refs/tags/v0.1.0-beta.2.tar.gz',    # I explain this later on
